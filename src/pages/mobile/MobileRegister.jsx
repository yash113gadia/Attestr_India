...
export default function MobileRegister() {
  ...
  return (
    <div className="pb-6">
      ...
      <div className="mb-5">
        <h1 className="font-serif text-[26px] text-ink leading-tight tracking-tight">Notarize</h1>
        ...
        {!user && user !== undefined && !file && (
          <motion.div key="auth" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <div className="p-6 text-center">
              ...
              <p className="text-[15px] text-ink mb-1 font-medium">Sign in to notarize</p>
                ...
                <div className="p-3 border-t border-rule-light">
                  <button onClick={handleRegister} disabled={registering}
                    ...
                    {registering ? (
                      ...
                      <><Blocks className="w-4 h-4" /> Notarize</>
                    )}
                  </button>
                </div>
              )}
